/**
 * Handles all the incoming Disptach payloads from the Gateway
...
class EventHandler{ 
    ...
    /**
     * Handles the Dispatch payloads from the Gateway
    ...
    async handleDispatch(payload){
        ...
        switch(t){
            ...
            case "GUILD_MEMBER_UPDATE":{
                ...
                this.client.users.update(d.user);
                console.log(this.client.guilds.get(d.guild_id).members.get(d.user.id));
                break;}
